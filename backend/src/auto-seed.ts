...
function runSeed(): void {
  ...
  const staffData = [
    ...
    { email: 'procto@clinica-tanah.com.br', full_name: 'Dr. André Mendes', role: 'doctor', cpf: '11166699907' },
  ...
  const employees = [
    ...
    { name: 'Dr. André Mendes', cpf: '11166699907', role: 'doctor', salary: 21500, dep: 2, spec: 'Proctologia' },
