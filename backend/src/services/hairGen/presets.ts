/**
 * Parameter catalogs from TANAH-HAIR-GEN (ABBYCRM/TANAH-HAIR-GEN).
 * Stable JSON-friendly contract for CRM + Gemini prompts.
 */

export const HAIRLINE_PRESETS: Record<string, { id: string; label: string; grafts: number; description: string }> = {
...
export const ZONE_PRESETS: Record<string, { id: string; label: string; grafts: number }> = {
...
export const LENGTH_PRESETS: Record<string, { id: string; label: string; px: number }> = {
...
export const COLOR_PRESETS: Record<string, { id: string; label: string }> = {
...
export const CURL_PRESETS: Record<string, { id: string; label: string }> = {
...
export const FULLNESS_PRESETS: Record<string, { id: string; label: string; densityMul: number }> = {
...
export const TECHNIQUE_PRESETS: Record<string, { id: string; label: string }> = {
  fue: { id: 'fue', label: 'FUE (Follicular Unit Extraction)' },
  fut: { id: 'fut', label: 'FUT (Strip)' },
  dhi: { id: 'dhi', label: 'DHI (Direct Hair Implantation)' },
};

export const SESSION_PRESETS: Record<string, { id: string; label: string }> = {
  single: { id: 'single', label: 'Single session' },
  multi: { id: 'multi', label: 'Multi-session' },
};

export const GRAFT_SCENARIOS: Record<string, { id: string; label: string; range: string }> = {
...
export const VIEW_CATALOG: Array<{ id: string; label: string; description: string }> = [
...
export function presetsCatalog() {
  return {
