...
await dp.getByTestId('login-email').fill('admin@clinica-tanah.com.br');
await dp.getByTestId('login-password').fill('clinica2026');
...
await mp.getByTestId('login-email').fill('admin@clinica-tanah.com.br');
await mp.getByTestId('login-password').fill('clinica2026');
